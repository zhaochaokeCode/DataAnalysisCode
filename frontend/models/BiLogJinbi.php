...
/**
 * This is the model class for table "bi_log_jinbi".
 *
 * @property integer $id
 ...
 * @property integer $f_jinbi_after
 * @property string $f_time
 * @property integer $f_type
 * @property string $f_other
 */
class BiLogJinbi extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['f_dept', 'f_server_address_id', 'f_game_id', 'f_sid', 'f_operative_id', 'f_character_id', 'f_character_grade', 'f_character_ip', 'f_opt_type', 'f_jinbi', 'f_jinbi_after', 'f_time', 'f_type', 'f_other'], 'required'],
            [['f_dept', 'f_server_address_id', 'f_game_id', 'f_sid', 'f_operative_id', 'f_character_id', 'f_character_grade', 'f_opt_type', 'f_jinbi', 'f_jinbi_after', 'f_type'], 'integer'],
            [['f_time'], 'safe'],
