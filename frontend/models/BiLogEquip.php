...
/**
 * This is the model class for table "bi_log_equip".
 *
 * @property integer $id
 ...
 */
class BiLogEquip extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['f_dept', 'f_server_address_id', 'f_game_id', 'f_sid', 'f_operative_id', 'f_character_id', 'f_character_grade', 'f_character_ip', 'f_model_id', 'f_id', 'f_goods_num', 'f_level_num', 'f_time', 'f_type', 'f_other'], 'required'],
            [['f_dept', 'f_server_address_id', 'f_game_id', 'f_sid', 'f_operative_id', 'f_character_id', 'f_character_grade', 'f_model_id', 'f_id', 'f_level_num', 'f_type'], 'integer'],
            [['f_time'], 'safe'],
